...
export const enums = {
  ...
  surveyScenarioMemberEventName: ["ApplicationEvent","BookRequestedEvent","CourseFinishedEvent","CourseStartedEvent","EmailConfirmedEvent","LeadCreatedEvent","LessonFinishedEvent","LessonStartedEvent","SolutionCheckedEvent","SurveyAnsweredEvent","SurveyScenarioStartedEvent","SurveyStartedEvent","UserSignedInEvent","UserSignedUpEvent"],
  surveyScenarioMemberState: ["started","finished"],
  surveyScenarioTriggerEventName: ["ApplicationEvent","BookRequestedEvent","CourseFinishedEvent","CourseStartedEvent","EmailConfirmedEvent","LeadCreatedEvent","LessonFinishedEvent","LessonStartedEvent","SolutionCheckedEvent","SurveyAnsweredEvent","SurveyScenarioStartedEvent","SurveyStartedEvent","UserSignedInEvent","UserSignedUpEvent"],
