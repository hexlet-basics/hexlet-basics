...
export default function Form({ data, url, method }: Props) {
  ...
  return (
    <XForm method={method} model="language" data={data} to={url}>
      <XSelect field="progress" labelField="name" valueField="id" items={languageProgressEnumOptions} />
      <XSelect field="learn_as" labelField="name" valueField="id" items={languageLearnAsEnumOptions} />
      <XInput field="slug" />
