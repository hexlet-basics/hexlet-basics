...
export default function ForTeachersBlock() {
  ...
  const programmingBasicList = t(
    "for_teachers.programming_basic_list",
    { returnObjects: true },
  );

  const interactiveApproachList = t(
    "for_teachers.interactive_approach_list",
    { returnObjects: true },
  );

  const earlyCareerGuidanceList = t(
    "for_teachers.early_career_guidance_list",
    { returnObjects: true },
  );

  const howToLearnCards = t(
    "for_teachers.how_to_learn_programming_cards",
    { returnObjects: true },
  );
      ...
      <Container className="py-3">
        ...
        <Row className="row-cols-1 row-cols-lg-2 py-5 gy-3">
          <Col>
            <div className="h1 fw-normal lh-1">
              {t("for_teachers.integrate_into_education")}
            </div>
          </Col>
          <Col>
            <p className="fs-5 text-body-secondary lh-sm pe-lg-4">
              {t("for_teachers.lay_programming_foundations")}
            </p>
          </Col>
        </Row>
          ...
          <Col>
            <div>
              <div className="fs-5 fw-medium lh-sm">
                {t("for_teachers.interactive_approach")}
              </div>
            ...
            <div className="pe-lg-5">
              <div className="fs-5 fw-medium lh-sm">
                {t("for_teachers.early_career_guidance")}
              </div>
          ...
          <div className="bg-dark text-light rounded-4 overflow-hidden p-3 p-lg-4">
            ...
            <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-5 gap-lg-0">
              <div className="text-white-50 lh-1">
                {t("for_teachers.open_browser_and_sign_up")}
              </div>
              {user.guest && (
                <Link
                ...
                >
                  <span>{t("for_teachers.sign_up")}</span>
                </Link>
              )}
              {!user.guest && (
                <Link
                  ...
                  rel="noreferrer"
                >
                  <span>{t("for_teachers.select_course")}</span>
                </Link>
              )}
            </div>
          </div>
        ...
        <div className="py-3 py-lg-5">
          <div className="h1 fw-normal lh-1 mb-4 mb-md-5 w-lg-75 w-xxl-50 pe-lg-4">
            {t("for_teachers.how_to_learn_programming")}
          </div>
