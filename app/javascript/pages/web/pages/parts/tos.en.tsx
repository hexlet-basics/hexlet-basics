...
export default function TosEn() {
  return (
    <>
      ...
      <p>
        We are TOO "Hexlet" ("Company," "we," "us," "our"), a company registered
      ...
      <p>
        ...
        address your request to: support@hexlet.io. If we ever grant you the
      ...
      <p>
        <strong>We may remove or edit your Content:</strong> By posting any
      ...
      <p>
        ...
        Services are hosted in Russia. If you access the Services from any other
        ...
        Russia, then through your continued use of the Services, you are
        transferring your data to Russia, and you expressly consent to have your
      ...
      <p>
        ...
        Kyrgyzstan. TOO "Hexlet" and yourself irrevocably consent that the
        courts of Kyrgyzstan shall have exclusive jurisdiction to resolve any
      ...
      <p>
        ...
        jurisdiction of the Kazakhstan courts. TOO "Hexlet" shall also maintain
      ...
      <p>
        ...
        THIRDPARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A
