...
import { decodeBase64UriComponent } from "@/lib/utils.ts";
import * as Routes from "@/routes.js";
import type { LanguageLesson, LessonCheckingResponse } from "@/types";
import type { LessonProps, LessonState } from "./types.ts";
        ...
        (set, get) => ({
          ...
          runCheck: async ({ course, lesson }) => {
            ...
            const responsePromise = axios.post<LessonCheckingResponse>(
              checkLessonPath,
              {
                data: { version_id: lesson.version_id, code: content },
              },
            );
            ...
            const result: LessonCheckingResponse & { output: string } = {
              ...response_data,
              output: decodeBase64UriComponent(response_data.output),
            };
            set((state) => ({
