...
export default interface Resources {
  "translation": {
      ...
      "errors": {
        "messages": {
          ...
          "restrict_dependent_destroy": {
            "has": "Невозможно удалить запись, так как существует зависимость: {{record}}" | "Невозможно удалить запись, так как существуют зависимости: {{record}}"
          }
        },
        "models": {
          "sign_up_form": {
    ...
    "admin": {
      "banners": {
        ...
        "form": {
          "body_hint": "Поддерживается Markdown (например, **жирный**). Весь баннер ведёт на ссылку из поля ниже."
        },
        "index": {
          "header": "Баннеры"
        },
  ...
  "title": "Пользователям доступен Виртуальный наставник на основе Искусственного интеллекта"
    ...
    "common": {
      ...
      "time": {
        "minutes": "{{count}} минут" | "{{count}} минута" | "{{count}} минуты" | "{{count}} минуты" | "{{count}} минут" | "{{count}} минут"
      },
      "tos": "Содержание",
  ...
  "title": "Пользователям доступен Виртуальный наставник на основе Искусственного интеллекта"
      ...
      "languages": {
        "index": {
          "categories": "Категории",
          "courses": "Все курсы",
          "header": "Курсы по языкам программирования",
          "hexlet": {
            "analytics": "Аналитик данных",
            "description": "Code Basics — это проект школы программирования Хекслет. Здесь вы закладываете базу и понимаете, как устроено программирование. Если хотите серьезно заняться разработкой и выйти на уровень профессии, переходите к платным программам Хекслет: с наставниками, практикой в реальных проектах и портфолио.",
            "devops": "DevOps-инженер с нуля",
            "frontend": "Фронтенд-разработчик",
            "go": "Go-разработчик",
            "java": "Java-разработчик",
            "programs": "Популярные программы Хекслет",
            "python": "Python-разработчик",
            "title": "От бесплатных основ к профессии: курсы Хекслет"
          },
          "reviews": "Отзывы"
        },
        "lessons": {
