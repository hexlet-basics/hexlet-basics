...
export default {
  translation: {
    ...
    check: {
      ...
      failed: {
        message: '<p>В вашем коде есть ошибки. Прочитайте внимательно вывод тестов и попробуйте найти их самостоятельно. <a href="http://help.hexlet.io/ru/articles/111500-kak-nayti-oshibki-v-kode" target="_blank">Как искать ошибки в коде</a>. Или воспользуйтесь помощью <a href="https://premium.hexlet.io/?utm_source=code-basics&utm_medium=referral" target="_blank">наставника</a></p><p class="mb-0">Если найти ошибку не получается, задайте вопрос в «Обсуждениях» к уроку. Для этого опишите проблему, скопируйте содержимое вкладки «Вывод» и приложите к вопросу</p>',
