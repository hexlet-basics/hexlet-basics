...
export default {
  translation: {
    ...
    check: {
      ...
      failed: {
        message: '<p>В вашем коде есть ошибки. Прочитайте внимательно вывод тестов и попробуйте найти их самостоятельно <a href="http://help.hexlet.io/ru/articles/111500-kak-nayti-oshibki-v-kode" target="_blank">Как искать ошибки в коде</a></p><p>Если найти ошибку не получается, задайте вопрос в «Обсуждениях» к уроку. Для этого опишите проблему, скопируйте содержимое вкладки «Вывод» и приложите к вопросу</p><p class="mb-0">Хотите проходить уроки в группе с наставником? Приходите на наш Подготовительный курс!</p>',
