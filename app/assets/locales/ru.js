export default {
  translation: {
    ...
    signInSuggestion:
      '<a href="/users/new">Создайте аккаунт</a> для сохранения прогресса',
    run: "Проверить",
    ...
    check: {
      ...
      failed: {
        message:
          'В вашем коде есть ошибки. Прочитайте внимательно вывод тестов, найдите и исправьте их. <a href="https://help.hexlet.ru/article/65315" target="_blank">Как искать ошибки в коде</a>. Если самостоятельно учиться сложно, попробуйте <a href="{{ url }}" target="_blank">обучение с наставником</a>',
