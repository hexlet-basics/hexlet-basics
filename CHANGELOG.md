...
## [0.2.0](https://github.com/hexlet-basics/hexlet-basics/compare/hexlet_basics-v0.1.3...hexlet_basics-v0.2.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* **api:** startLesson is public and returns the learner's position instead of 204. A guest progresses under the same rule, so the start command has to answer them too: it validates the gate and returns their position without storing anything, since only a check can move a cookie. Being public means it no longer carries the double-submit XSRF requirement, which is the same posture the check already has and which the SameSite=Lax session cookie covers — a cross-site POST carries no session to act with. Nothing consumes either operation yet: the player does not exist.
* **api:** name the fields after the concept, not the column
* **api:** move the admin routes onto the domain vocabulary
* **api:** rename the member family and the course-readiness enum

### refactor

* **api:** move the admin routes onto the domain vocabulary ([d83ad81](https://github.com/hexlet-basics/hexlet-basics/commit/d83ad81adb0293cfbbfda5a503dc6633471cfeba)), closes [#766](https://github.com/hexlet-basics/hexlet-basics/issues/766)
* **api:** name the fields after the concept, not the column ([e3a8a76](https://github.com/hexlet-basics/hexlet-basics/commit/e3a8a767090524eb6fbb93aef0ef91a7d073b4bc))
...
* **api:** give a guest the same progress the reads give a learner ([121947d](https://github.com/hexlet-basics/hexlet-basics/commit/121947d3315bf4f74af31a7844bf1c0be292b941))
* **api:** hand the lesson read the course's landing copy ([7687617](https://github.com/hexlet-basics/hexlet-basics/commit/7687617c6ceaf16f29e6c60fbbdce327bd19ba83))
* **api:** hand the lesson read the course's lesson list ([e645f33](https://github.com/hexlet-basics/hexlet-basics/commit/e645f3321e0ed8abe7acd0e84f9d4374f8a28b99))
* **api:** serve the lesson player payload with the visitor's progress ([c96e16c](https://github.com/hexlet-basics/hexlet-basics/commit/c96e16c472c241db7c41453f841a6c778612ad86)), closes [#760](https://github.com/hexlet-basics/hexlet-basics/issues/760)
* **api:** sign in from email links and require six-character passwords ([1613a38](https://github.com/hexlet-basics/hexlet-basics/commit/1613a3838c51d04001a535a9849899cd71beff14))
...
* **auth:** sign in through an emailed Magic Link ([2eb7180](https://github.com/hexlet-basics/hexlet-basics/commit/2eb718029280fb7f2db916ae69a018a2e6c22054))
...
* **ent:** map Enrollment and make the pair unique in PostgreSQL ([16f5de0](https://github.com/hexlet-basics/hexlet-basics/commit/16f5de0a721a38e36ef6644d13c204a0ed6019bf)), closes [#757](https://github.com/hexlet-basics/hexlet-basics/issues/757)
...
* **mail:** deliver account emails through Postbox from a River job ([24949de](https://github.com/hexlet-basics/hexlet-basics/commit/24949deddb8f9dc4f5cf47729e6dd94a48895be9))
* **progress:** count a new enrollment on its course ([b5116a6](https://github.com/hexlet-basics/hexlet-basics/commit/b5116a632bcaee5524e18b4caf6a8053e5337c14)), closes [#755](https://github.com/hexlet-basics/hexlet-basics/issues/755)
* **progress:** implement the learner dashboard ([42df493](https://github.com/hexlet-basics/hexlet-basics/commit/42df49323971324829f08fad9cd9d71be9f432b2)), closes [#763](https://github.com/hexlet-basics/hexlet-basics/issues/763)
* **progress:** merge guest progress on sign-up and sign-in ([6813992](https://github.com/hexlet-basics/hexlet-basics/commit/6813992f530ab1d70fa2a36689030e07705df6af)), closes [#762](https://github.com/hexlet-basics/hexlet-basics/issues/762)
* **progress:** re-evaluate completion when a version is promoted ([da411de](https://github.com/hexlet-basics/hexlet-basics/commit/da411de950735eaf671ad831f162bfaa63fe3ae9)), closes [#764](https://github.com/hexlet-basics/hexlet-basics/issues/764)
* **progress:** record progress when a solution is checked ([254e3e4](https://github.com/hexlet-basics/hexlet-basics/commit/254e3e41276f8ae728ae1a59223ce8b32668c19f)), closes [#759](https://github.com/hexlet-basics/hexlet-basics/issues/759)
* **progress:** return the learner's position from the course read ([4c7abb9](https://github.com/hexlet-basics/hexlet-basics/commit/4c7abb9193dd943eef6c047a84e4f1711419c9df)), closes [#760](https://github.com/hexlet-basics/hexlet-basics/issues/760)
* **progress:** run submitted solutions in Docker ([6d5f563](https://github.com/hexlet-basics/hexlet-basics/commit/6d5f56340e5939ea133c6f171e095319a58b8c4b)), closes [#755](https://github.com/hexlet-basics/hexlet-basics/issues/755)
* **progress:** sign and carry guest progress in a cookie ([7c9269a](https://github.com/hexlet-basics/hexlet-basics/commit/7c9269aa45d89b4dd0e60604321c5468276550f8)), closes [#761](https://github.com/hexlet-basics/hexlet-basics/issues/761)
* **progress:** start a lesson ([5136f1e](https://github.com/hexlet-basics/hexlet-basics/commit/5136f1e9104b4969779c2c5cb2472ecd076d6419)), closes [#758](https://github.com/hexlet-basics/hexlet-basics/issues/758)
* **web:** build the lesson page shell ([6d23d88](https://github.com/hexlet-basics/hexlet-basics/commit/6d23d8828fdb6ec61912d076584c74380ed43b01))
* **web:** give the lesson player its editor ([33a94bd](https://github.com/hexlet-basics/hexlet-basics/commit/33a94bd64edfc78d6426391f1854ca8792f3eda6)), closes [#773](https://github.com/hexlet-basics/hexlet-basics/issues/773)
* **web:** let the learner run their solution ([8eebd97](https://github.com/hexlet-basics/hexlet-basics/commit/8eebd975cf408b28ee24eac6ac36e247c0928419)), closes [#774](https://github.com/hexlet-basics/hexlet-basics/issues/774)
* **web:** reset a forgotten password end to end ([90d3d30](https://github.com/hexlet-basics/hexlet-basics/commit/90d3d30ba43ebe12bc9b9fc95bae3f09f378be51)), closes [#794](https://github.com/hexlet-basics/hexlet-basics/issues/794)
* **web:** sign in with a Magic Link in the browser ([51bc7f8](https://github.com/hexlet-basics/hexlet-basics/commit/51bc7f8fe59a035690185c27aa302344b701269f)), closes [#792](https://github.com/hexlet-basics/hexlet-basics/issues/792)


### Bug Fixes

* **amocrm:** generate the client with ogen and stop duplicate retries ([6124aac](https://github.com/hexlet-basics/hexlet-basics/commit/6124aac8c91f5a26ee617b05059af4d32daf7930))
...
* **progress:** stop a container that never exits from wedging the runner ([4448119](https://github.com/hexlet-basics/hexlet-basics/commit/444811959575b221f9d5e94ef70b74687ed5058d)), closes [#755](https://github.com/hexlet-basics/hexlet-basics/issues/755)
...
* **web:** keep every keystroke the learner types ([f0edc6b](https://github.com/hexlet-basics/hexlet-basics/commit/f0edc6b7120813738b7a0aa744a761cbdbefa58b))
* **web:** keep the URL locale after hydration ([89bce70](https://github.com/hexlet-basics/hexlet-basics/commit/89bce70932cae33011f23ea8a220a4d2a8da38aa))
* **web:** style code blocks and guard the chrome switch ([949abac](https://github.com/hexlet-basics/hexlet-basics/commit/949abac253b6e9408191fe24aeac9e987f9ab066))
* **web:** tighten the Password Reset pages after review ([45e3d1a](https://github.com/hexlet-basics/hexlet-basics/commit/45e3d1a4c973e839b5991495c8db7e40c4a80cde)), closes [#794](https://github.com/hexlet-basics/hexlet-basics/issues/794)
...
* add openspec skills and config ([2e75777](https://github.com/hexlet-basics/hexlet-basics/commit/2e75777de9d9d51088f215ea15e3f5b15ad50212))
...
* drop openspec in favour of the mattpocock skills ([c86d188](https://github.com/hexlet-basics/hexlet-basics/commit/c86d18886e2aaeb2fbc003016039055f8ed53410))
...
* update gitignore ([61a98af](https://github.com/hexlet-basics/hexlet-basics/commit/61a98af6475467d2253492d0da9b742848aaf8fe))
...
* **deps:** move openai-go to the v3 module ([7b8e753](https://github.com/hexlet-basics/hexlet-basics/commit/7b8e753a8c863a104d1e91ab3ca5406873b68575))
* **deps:** move to vitest 5 ([ab473d5](https://github.com/hexlet-basics/hexlet-basics/commit/ab473d55e552126b4b327ee2c89d700f7f6cad97))
* **deps:** update Go and JS dependencies ([d593d11](https://github.com/hexlet-basics/hexlet-basics/commit/d593d116f3625ccfd57988fe78bf722109c733d9))
* **deps:** update Go and JS dependencies ([a64d775](https://github.com/hexlet-basics/hexlet-basics/commit/a64d77593dda1135ff55c1be6763e716bf8c2a58))
...
* install the Atlas Community CLI and record schema ownership ([85a2c84](https://github.com/hexlet-basics/hexlet-basics/commit/85a2c84951b8e524d5662a6ba898ecb0b336d21a))
* move to Go 1.27 ([5042ec6](https://github.com/hexlet-basics/hexlet-basics/commit/5042ec67f637700ed7be956e0e590ab9cac6254b))
* pin air and golangci-lint as go tools instead of mise ([f4602c6](https://github.com/hexlet-basics/hexlet-basics/commit/f4602c6d5cea675932073911644d3744cff1557d))
* pin node and pnpm in mise ([b259d0b](https://github.com/hexlet-basics/hexlet-basics/commit/b259d0b94c39275834e6d7e41fc0a3b62a590c43))
* put golangci-lint back on mise, keep air as a go tool ([3066945](https://github.com/hexlet-basics/hexlet-basics/commit/3066945b802a295d9a4fe207dd742f198b9bf53d))
