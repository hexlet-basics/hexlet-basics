...
class Language::LandingPage
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Language::LandingPage]])
    end
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Boolean) }
    def language_category_changed?; end
  ...
  class PrivateAASMMachine < AASM::Base
    sig do
      params(
        ...
        block: T.nilable(T.proc.bind(Language::LandingPage).void)
      ).returns(T.untyped)
    end
    ...
    class PrivateAASMEvent < AASM::Core::Event
      sig do
        params(
          ...
          block: T.nilable(T.proc.bind(Language::LandingPage).params(opts: T.untyped).void)
        ).returns(T.untyped)
      end
