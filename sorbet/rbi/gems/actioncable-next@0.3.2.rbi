...
# :include: ../README.md
#
# pkg:gem/actioncable-next#lib/action_cable.rb:57
module ActionCable
  private

  # Singleton instance of the server
  #
  # pkg:gem/actioncable-next#lib/action_cable.rb:80
  def server; end

  class << self
    # pkg:gem/actioncable-next#lib/action_cable/deprecator.rb:6
    def deprecator; end

    # Returns the currently loaded version of Action Cable as a `Gem::Version`.
    #
    # pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:7
    def gem_version; end
    ...
    # Returns the currently loaded version of Action Cable as a `Gem::Version`.
    #
    # pkg:gem/actioncable-next#lib/action_cable/version.rb:9
    def version; end
  end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:9
...
#
# pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:109
class ActionCable::Channel::Base
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:157
  def initialize(connection, identifier, params = T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:110
  def __callbacks; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:117
  def connection; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:118
  ...
  # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:111
  def periodic_timers=(_arg0); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:115
  ...
  class << self
    ...
    #
    # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:128
    ...
    #
    # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:147
    def clear_action_methods!; end

    # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:151
    def internal_methods; end

    # Refresh the cached action_methods when a new action_method is added.
    #
    # pkg:gem/actioncable-next#lib/action_cable/channel/base.rb:156
    def method_added(name); end
  end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:9
module ActionCable::Channel::Broadcasting
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::ActionCable::Channel::Broadcasting::ClassMethods

  # pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:45
  def broadcast_to(model, message); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:41
  def broadcasting_for(model); end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:12
module ActionCable::Channel::Broadcasting::ClassMethods
  # Broadcast a hash to a unique broadcasting for this array of `broadcastables` in this channel.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:14
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:24
  def broadcasting_for(broadcastables); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/channel/broadcasting.rb:29
...
#     end
#
# pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:38
...
# pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:49
module ActionCable::Channel::Callbacks::ClassMethods
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:62
  def after_subscribe(*methods, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:71
  def after_unsubscribe(*methods, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:50
  def before_subscribe(*methods, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:67
  ...
  #     after_subscribe :my_method, unless: :subscription_rejected?
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:65
  def on_subscribe(*methods, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:74
  def on_unsubscribe(*methods, &block); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:77
  def internal_methods; end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/callbacks.rb:42
...
#
# pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:24
module ActionCable::Channel::ChannelExt
  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:25
  def confirmed?; end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:27
  def rejected?; end

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:29
  def stream_names; end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/naming.rb:7
module ActionCable::Channel::Naming
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::ActionCable::Channel::Naming::ClassMethods

  # pkg:gem/actioncable-next#lib/action_cable/channel/naming.rb:23
  def channel_name; end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/naming.rb:10
module ActionCable::Channel::Naming::ClassMethods
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/naming.rb:18
  def channel_name; end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:12
class ActionCable::Channel::NonInferrableChannelError < ::StandardError
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:13
  def initialize(name); end
end

# pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:7
module ActionCable::Channel::PeriodicTimers
  ...
  # pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:56
  def active_periodic_timers; end

  # pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:66
  def start_periodic_timer(timer_callback, every:); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:60
  def start_periodic_timers; end

  # pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:75
...
# pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:17
module ActionCable::Channel::PeriodicTimers::ClassMethods
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/periodic_timers.rb:31
...
#
# pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:77
module ActionCable::Channel::Streams
  extend ::ActiveSupport::Concern

  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:153
  def pubsub(*_arg0, **_arg1, &_arg2); end

  # Unsubscribes all streams associated with this channel from the pubsub queue.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:135
  def stop_all_streams; end

  # Unsubscribes streams for the `model`.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:130
  def stop_stream_for(model); end

  # Unsubscribes streams from the named `broadcasting`.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:121
  ...
  # messages.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:116
  ...
  # messages.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:90
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:144
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:200
  def default_stream_handler(broadcasting, coder:); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:221
  def identity_handler; end

  # Optimized stream handler that avoids double JSON encoding/decoding on broadcast
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:174
  def opt_worker_pool_stream_handler(broadcasting); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:205
  ...
  # TODO: Tests demonstrating this.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:184
  def stream_handler(broadcasting, user_handler, coder: T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:213
  def stream_transmitter(handler = T.unsafe(nil), broadcasting:); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:155
  def streams; end

  # Always wrap the outermost handler to invoke the user handler on the worker
  # pool rather than blocking the event loop.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/streams.rb:161
...
#     end
#
# pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:134
class ActionCable::Channel::TestCase < ::ActionCable::Connection::TestCase
  ...
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:144
...
# pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:135
module ActionCable::Channel::TestCase::Behavior
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:246
  def advance_time(seconds); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:261
  def assert_broadcast_on(stream_or_object, *args); end

  # Enhance TestHelper assertions to handle non-String broadcastings
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:257
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:307
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:319
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:284
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:296
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:272
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:236
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:207
  ...
  # as a Hash.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:219
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:198
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:251
  def transmissions; end

  # Unsubscribe the subscription under test.
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:228
  def unsubscribe; end

  private

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:328
  def broadcasting_for(stream_or_object); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:324
...
# pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:141
ActionCable::Channel::TestCase::Behavior::CHANNEL_IDENTIFIER = T.let(T.unsafe(nil), String)

# pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:149
module ActionCable::Channel::TestCase::Behavior::ClassMethods
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:161
  def channel_class; end

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:180
  def connection_class; end

  # @raise [NonInferrableChannelError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:188
  def determine_default_channel(name); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:150
  def tests(channel); end

  # pkg:gem/actioncable-next#lib/action_cable/channel/test_case.rb:169
  def tests_connection(connection); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/identification.rb:6
module ActionCable::Connection; end

# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:22
module ActionCable::Connection::Assertions
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:28
  def assert_reject_connection(&block); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/authorization.rb:7
module ActionCable::Connection::Authorization
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/authorization.rb:12
  def reject_unauthorized_connection; end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/authorization.rb:8
...
#
# pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:55
class ActionCable::Connection::Base
  ...
  # @return [Base] a new instance of Base
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:68
  def initialize(server, socket); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:59
  def __callbacks; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:146
  def beat; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:65
  def broadcast(*_arg0, **_arg1, &_arg2); end

  # Close the connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:125
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:83
  def connect; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:88
  def disconnect; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:66
  def env(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:65
  def executor(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:106
  def handle_channel_command(payload); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:99
  def handle_close; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:114
  def handle_incoming(payload); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:91
  def handle_open; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:56
  def identifiers; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:150
  def inspect; end

  # Returns the value of attribute logger.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:62
  def logger; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:120
  def raw_transmit(data); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:66
  def request(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:60
  def rescue_handlers; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:137
  def statistics; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:116
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:156
  def cookies; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:160
  def send_welcome_message; end

  # Returns the value of attribute server.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:63
  def server; end
  ...
  class << self
    ...
    # pkg:gem/actioncable-next#lib/action_cable/connection/base.rb:173
...
#     end
#
# pkg:gem/actioncable-next#lib/action_cable/connection/callbacks.rb:34
...
# pkg:gem/actioncable-next#lib/action_cable/connection/callbacks.rb:42
module ActionCable::Connection::Callbacks::ClassMethods
  # pkg:gem/actioncable-next#lib/action_cable/connection/callbacks.rb:47
  def after_command(*methods, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/callbacks.rb:51
  def around_command(*methods, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/callbacks.rb:43
  def before_command(*methods, &block); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/identification.rb:7
module ActionCable::Connection::Identification
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/identification.rb:29
  def connection_identifier; end

  private

  # pkg:gem/actioncable-next#lib/action_cable/connection/identification.rb:38
...
# pkg:gem/actioncable-next#lib/action_cable/connection/identification.rb:14
module ActionCable::Connection::Identification::ClassMethods
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/identification.rb:21
...
# connection.
#
# pkg:gem/actioncable-next#lib/action_cable/connection/internal_channel.rb:11
module ActionCable::Connection::InternalChannel
  extend ::ActiveSupport::Concern

  private

  # pkg:gem/actioncable-next#lib/action_cable/connection/internal_channel.rb:15
  def internal_channel; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/internal_channel.rb:36
  def process_internal_message(message); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/internal_channel.rb:19
  def subscribe_to_internal_channel; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/internal_channel.rb:30
  def unsubscribe_from_internal_channel; end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:14
class ActionCable::Connection::NonInferrableConnectionError < ::StandardError
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:15
  def initialize(name); end
end
...
#
# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:14
class ActionCable::Connection::Subscriptions
  # @return [Subscriptions] a new instance of Subscriptions
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:47
  def initialize(connection); end

  # @raise [MalformedCommandError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:62
  def add(data); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:52
  def execute_command(data); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:94
  def identifiers; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:104
  def logger(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:90
  def perform_action(data); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:80
  def remove(data); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:85
  def remove_subscription(subscription); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:98
  ...
  # Returns the value of attribute connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:103
  def connection; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:106
  def find(data); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:114
...
# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:17
class ActionCable::Connection::Subscriptions::AlreadySubscribedError < ::ActionCable::Connection::Subscriptions::Error
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:18
  def initialize(identifier); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:23
class ActionCable::Connection::Subscriptions::ChannelNotFound < ::ActionCable::Connection::Subscriptions::Error
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:24
  def initialize(channel_id); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:15
class ActionCable::Connection::Subscriptions::Error < ::StandardError; end

# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:29
class ActionCable::Connection::Subscriptions::MalformedCommandError < ::ActionCable::Connection::Subscriptions::Error
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:30
  def initialize(data); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:35
class ActionCable::Connection::Subscriptions::UnknownCommandError < ::ActionCable::Connection::Subscriptions::Error
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:36
  def initialize(command); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:41
class ActionCable::Connection::Subscriptions::UnknownSubscription < ::ActionCable::Connection::Subscriptions::Error
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/subscriptions.rb:42
  def initialize(identifier); end
end
...
#     end
#
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:240
class ActionCable::Connection::TestCase < ::ActiveSupport::TestCase
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:250
...
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:241
module ActionCable::Connection::TestCase::Behavior
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:294
  def connect(path = T.unsafe(nil), server: T.unsafe(nil), **request_params); end

  # Returns the value of attribute connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:284
  def connection; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:314
  def cookies; end

  # Exert #disconnect on the connection under test.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:307
  def disconnect; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:318
  def transmissions; end
...
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:255
module ActionCable::Connection::TestCase::Behavior::ClassMethods
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:267
  def connection_class; end

  # @raise [NonInferrableConnectionError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:275
  def determine_default_connection(name); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:256
  def tests(connection); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:244
...
#
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:43
class ActionCable::Connection::TestCookieJar < ::ActionCable::Connection::TestCookies
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:48
  def encrypted; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:44
  def signed; end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:33
class ActionCable::Connection::TestCookies < ::ActiveSupport::HashWithIndifferentAccess
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:34
  def []=(name, options); end
end

# TestServer provides test pub/sub and executor implementations
#
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:134
class ActionCable::Connection::TestServer
  # @return [TestServer] a new instance of TestServer
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:137
  def initialize(server); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:155
  def advance_time(seconds); end

  # Returns the value of attribute config.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:135
  def config; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:144
  def executor; end

  # Inline async calls
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:149
  def post(&work); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:143
  def pubsub; end
  ...
  # == Pub/sub interface ==
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:160
  def subscribe(stream, callback, success_callback = T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:151
  def timer(every, &block); end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:165
  def unsubscribe(stream, callback); end
end

# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:53
class ActionCable::Connection::TestSocket
  # @return [TestSocket] a new instance of TestSocket
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:85
  def initialize(request); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:100
  def close; end

  # Returns the value of attribute closed.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:59
  def closed; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:104
  def perform_work(receiver, method_name, *args); end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:96
  def transmit(data); end

  class << self
    # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:62
...
#
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:55
class ActionCable::Connection::TestSocket::Request < ::ActionDispatch::TestRequest
  # Returns the value of attribute cookie_jar.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:56
  def cookie_jar; end
...
# pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:109
class ActionCable::Connection::TestTimer
  # @return [TestTimer] a new instance of TestTimer
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:112
  def initialize(interval, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:123
  def advance(seconds); end

  # Returns the value of attribute interval.
  #
  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:110
  def interval; end

  # pkg:gem/actioncable-next#lib/action_cable/connection/test_case.rb:119
  def shutdown; end
end

# pkg:gem/actioncable-next#lib/action_cable/engine.rb:10
class ActionCable::Engine < ::Rails::Engine; end

# pkg:gem/actioncable-next#lib/action_cable/helpers/action_cable_helper.rb:6
module ActionCable::Helpers; end

# pkg:gem/actioncable-next#lib/action_cable/helpers/action_cable_helper.rb:7
module ActionCable::Helpers::ActionCableHelper
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/helpers/action_cable_helper.rb:36
  def action_cable_meta_tag; end
end

# pkg:gem/actioncable-next#lib/action_cable.rb:61
...
#
# pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:31
class ActionCable::RemoteConnections
  # @return [RemoteConnections] a new instance of RemoteConnections
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:34
  def initialize(server); end

  # Returns the value of attribute server.
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:32
  def server; end

  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:38
...
#
# pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:47
class ActionCable::RemoteConnections::RemoteConnection
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:52
  def initialize(server, ids); end

  # Uses the internal channel to disconnect the connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:58
  def disconnect(reconnect: T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:50
  def identifiers; end
  ...
  # Returns the value of attribute server.
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:68
  def server; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:71
  def set_identifier_instance_vars(ids); end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:76
...
# pkg:gem/actioncable-next#lib/action_cable/remote_connections.rb:48
class ActionCable::RemoteConnections::RemoteConnection::InvalidIdentifiersError < ::StandardError; end

# pkg:gem/actioncable-next#lib/action_cable/server/base.rb:8
...
# more information.
#
# pkg:gem/actioncable-next#lib/action_cable/server/base.rb:41
class ActionCable::Server::Base
  ...
  # @return [Base] a new instance of Base
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:54
  ...
  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:146
  def allow_request_origin?(env); end

  # Called by Rack to set up the server.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:61
  def call(env); end

  # Returns the value of attribute config.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:47
  def config; end

  # All of the identifiers applied to the connection class associated with this
  # server.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:134
  def connection_identifiers; end

  # Disconnect all the connections identified by `identifiers` on this server or
  # any others via RemoteConnections.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:69
  def disconnect(identifiers); end

  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:98
  def event_loop; end

  # Executor is used by various actions within Action Cable (e.g., pub/sub operations) to run code asynchronously.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:123
  def executor; end

  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:50
  def logger(*_arg0, **_arg1, &_arg2); end

  # Returns the value of attribute mutex.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:52
  def mutex; end

  # Tags are declared in the server but computed in the connection. This allows us per-connection tailored tags.
  # You can pass request object either directly or via block to lazily evaluate it.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:140
  def new_tagged_logger(request = T.unsafe(nil), &block); end

  # Adapter used for all streams/broadcasting.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:128
  def pubsub; end

  # Gateway to RemoteConnections. See that class for details.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:94
  def remote_connections; end

  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:73
  def restart; end
  ...
  # instead.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:118
  def worker_pool; end

  class << self
    # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:45
    def config; end

    # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:45
    def config=(val); end

    # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:49
    def logger; end
  end
end
...
#     });
#
# pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:30
module ActionCable::Server::Broadcasting
  # Broadcast a hash directly to a named `broadcasting`. This will later be JSON
  # encoded.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:33
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:40
  def broadcaster_for(broadcasting, coder: T.unsafe(nil)); end
end

# pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:45
class ActionCable::Server::Broadcasting::Broadcaster
  # @return [Broadcaster] a new instance of Broadcaster
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:48
  def initialize(server, broadcasting, coder:); end

  # pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:52
  def broadcast(message); end

  # Returns the value of attribute broadcasting.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/broadcasting.rb:46
...
#
# pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:14
class ActionCable::Server::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:24
  def initialize; end

  # Returns the value of attribute allow_same_origin_as_host.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:17
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:18
  def cable; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:16
  def connection_class; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:22
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:20
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:15
  def log_tags; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:19
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:45
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/configuration.rb:21
...
#
# pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:13
module ActionCable::Server::Connections
  # pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:22
  def add_connection(connection); end

  # pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:20
  def connections; end

  # pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:16
  def connections_map; end

  # pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:41
  def open_connections_statistics; end

  # pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:26
  ...
  # disconnect.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:35
  def setup_heartbeat_timer; end
end

# pkg:gem/actioncable-next#lib/action_cable/server/connections.rb:14
...
#
# pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:11
class ActionCable::Server::Socket
  # @return [Socket] a new instance of Socket
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:17
  def initialize(server, env, coder: T.unsafe(nil)); end

  # Close the WebSocket connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:57
  def close(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:15
  def config(*_arg0, **_arg1, &_arg2); end

  # Returns the value of attribute connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:12
  def connection; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:84
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:111
  def inspect; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:107
  def on_close(reason, code); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:102
  def on_error(message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:98
  def on_message(message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:94
  def on_open; end

  # Invoke a method on the connection asynchronously through the pool of thread workers.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:62
  def perform_work(receiver, method, *args); end

  # Called by the server when a new WebSocket connection is established.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:31
  def process; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:50
  def raw_transmit(message); end

  # Decodes WebSocket messages and dispatches them to subscribed channels.
  # WebSocket message transfer encoding is always JSON.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:80
  def receive(websocket_message); end

  # The request that initiated the WebSocket connection is available here. This gives access to the environment, cookies, etc.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:71
  def request; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:66
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:44
  def transmit(cable_message); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:123
  def decode(websocket_message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:119
  def encode(cable_message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:165
  def finished_request_message; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:136
  def handle_close; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:127
  def handle_open; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:173
  def invalid_request_message; end

  # Returns the value of attribute message_buffer.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:117
  def message_buffer; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:148
  def respond_to_invalid_request; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:143
  def respond_to_successful_request; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:156
  def started_request_message; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:179
  def successful_request_message; end

  # Returns the value of attribute websocket.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:116
  def websocket; end

  # Returns the value of attribute worker_pool.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket.rb:13
  def worker_pool; end
end

# pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:12
class ActionCable::Server::Socket::ClientSocket
  # @return [ClientSocket] a new instance of ClientSocket
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:35
  def initialize(env, event_target, event_loop, protocols); end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:113
  def alive?; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:109
  def client_gone; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:91
  def close(code = T.unsafe(nil), reason = T.unsafe(nil)); end

  # Returns the value of attribute env.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:33
  def env; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:105
  def parse(data); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:117
  def protocol; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:70
  def rack_response; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:58
  def start_driver; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:81
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:75
  def write(data); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:141
  def begin_close(reason, code); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:135
  def emit_error(message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:150
  def finalize_close; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:122
  def open; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:129
  def receive_message(data); end

  class << self
    # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:13
    def determine_url(env); end

    # @return [Boolean]
    #
    # pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:18
    def secure_request?(env); end
  end
end

# pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:31
ActionCable::Server::Socket::ClientSocket::CLOSED = T.let(T.unsafe(nil), Integer)

# pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:30
ActionCable::Server::Socket::ClientSocket::CLOSING = T.let(T.unsafe(nil), Integer)

# pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:28
ActionCable::Server::Socket::ClientSocket::CONNECTING = T.let(T.unsafe(nil), Integer)

# pkg:gem/actioncable-next#lib/action_cable/server/socket/client_socket.rb:29
ActionCable::Server::Socket::ClientSocket::OPEN = T.let(T.unsafe(nil), Integer)

# Allows us to buffer messages received from the WebSocket before the Connection has been fully initialized, and is ready to receive them.
#
# pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:7
class ActionCable::Server::Socket::MessageBuffer
  # @return [MessageBuffer] a new instance of MessageBuffer
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:8
  def initialize(connection); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:13
  def append(message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:29
  def process!; end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:25
  def processing?; end

  private

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:46
  def buffer(message); end

  # Returns the value of attribute buffered_messages.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:36
  def buffered_messages; end

  # Returns the value of attribute connection.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:35
  def connection; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:42
  def receive(message); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:50
  def receive_buffered_messages; end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/message_buffer.rb:38
  def valid?(message); end
end

# pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:10
class ActionCable::Server::Socket::Stream
  # @return [Stream] a new instance of Stream
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:11
  def initialize(event_loop, socket); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:27
  def close; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:23
  def each(&callback); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:71
  def flush_write_buffer; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:97
  def hijack_rack_socket; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:93
  def receive(data); end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:32
  def shutdown; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:36
  def write(data); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/stream.rb:109
...
#
# pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:13
class ActionCable::Server::Socket::WebSocket
  # @return [WebSocket] a new instance of WebSocket
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:14
  def initialize(env, event_target, event_loop, protocols: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:22
  def alive?; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:30
  def close(*_arg0, **_arg1, &_arg2); end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:18
  def possible?; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:34
  def protocol; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:38
  def rack_response; end

  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:26
  ...
  # Returns the value of attribute websocket.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/socket/web_socket.rb:43
  def websocket; end
end

# pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:9
class ActionCable::Server::StreamEventLoop
  # @return [StreamEventLoop] a new instance of StreamEventLoop
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:10
  def initialize; end

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:19
  def attach(io, stream); end

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:27
  def detach(io, stream); end

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:45
  def stop; end

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:36
  def writes_pending(io); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:69
  def run; end

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:51
  def spawn; end

  # pkg:gem/actioncable-next#lib/action_cable/server/stream_event_loop.rb:65
  def wakeup; end
end
...
#
# pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:12
class ActionCable::Server::TaggedLoggerProxy
  # @return [TaggedLoggerProxy] a new instance of TaggedLoggerProxy
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:15
  def initialize(logger, tags:); end

  # pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:20
  def add_tags(*tags); end

  # pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:35
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:25
  def tag(logger, &block); end

  # Returns the value of attribute tags.
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:13
  def tags; end
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/tagged_logger_proxy.rb:41
  def log(type, message, &block); end
end

# A wrapper over ConcurrentRuby::ThreadPoolExecutor and Concurrent::TimerTask
#
# pkg:gem/actioncable-next#lib/action_cable/server/base.rb:10
class ActionCable::Server::ThreadedExecutor
  # @return [ThreadedExecutor] a new instance of ThreadedExecutor
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:11
  def initialize(max_size: T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:20
  def post(task = T.unsafe(nil), &block); end

  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:29
  def shutdown; end

  # pkg:gem/actioncable-next#lib/action_cable/server/base.rb:25
  def timer(interval, &block); end
end

# Worker used by Server.send_async to do connection work in threads.
#
# pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:12
class ActionCable::Server::Worker
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:21
  def initialize(max_size: T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:13
  def __callbacks; end

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:16
  ...
  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:48
  def async_exec(receiver, *args, connection:, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:52
  def async_invoke(receiver, method, *args, connection: T.unsafe(nil), &block); end

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:15
  def connection; end
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:19
  def executor; end

  # Stop processing work: any work that has not already started running will be
  # discarded from the queue
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:32
  def halt; end

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:58
  def invoke(receiver, method, *args, connection:, &block); end

  # @return [Boolean]
  #
  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:36
  def stopping?; end

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:40
  def work(connection, &block); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/server/worker.rb:70
  def logger; end
...
# pkg:gem/actioncable-next#lib/action_cable/server/worker/active_record_connection_management.rb:8
module ActionCable::Server::Worker::ActiveRecordConnectionManagement
  extend ::ActiveSupport::Concern

  # pkg:gem/actioncable-next#lib/action_cable/server/worker/active_record_connection_management.rb:17
  def with_database_connections(&block); end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:6
module ActionCable::SubscriptionAdapter; end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/async.rb:7
class ActionCable::SubscriptionAdapter::Async < ::ActionCable::SubscriptionAdapter::Inline
  private

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/async.rb:9
  def new_subscriber_map; end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:7
class ActionCable::SubscriptionAdapter::Base
  # @return [Base] a new instance of Base
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:13
  def initialize(server); end

  # @raise [NotImplementedError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:18
  def broadcast(channel, payload); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:34
  def identifier; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:11
  def logger(*_arg0, **_arg1, &_arg2); end

  # @raise [NotImplementedError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:30
  def shutdown; end

  # @raise [NotImplementedError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:22
  def subscribe(channel, message_callback, success_callback = T.unsafe(nil)); end

  # @raise [NotImplementedError]
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:26
  ...
  # Returns the value of attribute config.
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:9
  def config; end

  # Returns the value of attribute executor.
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/base.rb:8
  def executor; end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/channel_prefix.rb:7
module ActionCable::SubscriptionAdapter::ChannelPrefix
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/channel_prefix.rb:8
  def broadcast(channel, payload); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/channel_prefix.rb:13
  def subscribe(channel, callback, success_callback = T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/channel_prefix.rb:18
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/channel_prefix.rb:25
  def channel_with_prefix(channel); end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:7
class ActionCable::SubscriptionAdapter::Inline < ::ActionCable::SubscriptionAdapter::Base
  # @return [Inline] a new instance of Inline
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:8
  def initialize(*_arg0); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:14
  def broadcast(channel, payload); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:26
  def shutdown; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:18
  def subscribe(channel, callback, success_callback = T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:22
  def unsubscribe(channel, callback); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:35
  def new_subscriber_map; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/inline.rb:31
  def subscriber_map; end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:11
class ActionCable::SubscriptionAdapter::PostgreSQL < ::ActionCable::SubscriptionAdapter::Base
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:14
  def initialize(*_arg0); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:20
  def broadcast(channel, payload); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:34
  def shutdown; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:26
  def subscribe(channel, callback, success_callback = T.unsafe(nil)); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:30
  def unsubscribe(channel, callback); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:52
  def with_broadcast_connection(&block); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:38
  def with_subscriptions_connection(&block); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:61
  def channel_identifier(channel); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:65
  def listener; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:69
  def verify!(pg_conn); end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:75
class ActionCable::SubscriptionAdapter::PostgreSQL::Listener < ::ActionCable::SubscriptionAdapter::SubscriberMap::Async
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:76
  def initialize(adapter, executor); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:119
  def add_channel(channel, on_success); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:88
  def listen; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:123
  def remove_channel(channel); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/postgresql.rb:114
  def shutdown; end
end

class ActionCable::SubscriptionAdapter::SolidCable < ::ActionCable::SubscriptionAdapter::Base; end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:7
class ActionCable::SubscriptionAdapter::SubscriberMap
  # @return [SubscriberMap] a new instance of SubscriberMap
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:21
  def initialize; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:64
  def add_channel(channel, on_success); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:26
  def add_subscriber(channel, subscriber, on_success); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:51
  def broadcast(channel, message); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:71
  def invoke_callback(callback, message); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:68
  def remove_channel(channel); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:40
  def remove_subscriber(channel, subscriber); end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:75
class ActionCable::SubscriptionAdapter::SubscriberMap::Async < ::ActionCable::SubscriptionAdapter::SubscriberMap
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:76
  def initialize(executor); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:81
  def add_subscriber(*_arg0); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:89
  def invoke_callback(*_arg0); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:85
  def remove_subscriber(*_arg0); end
end

# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:8
class ActionCable::SubscriptionAdapter::SubscriberMap::Message < ::Struct
  # @return [Message] a new instance of Message
  #
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:9
  def initialize(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/subscriber_map.rb:14
...
#
# pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/test.rb:17
class ActionCable::SubscriptionAdapter::Test < ::ActionCable::SubscriptionAdapter::Async
  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/test.rb:18
  def broadcast(channel, payload); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/test.rb:23
  def broadcasts(channel); end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/test.rb:31
  def clear; end

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/test.rb:27
  def clear_messages(channel); end

  private

  # pkg:gem/actioncable-next#lib/action_cable/subscription_adapter/test.rb:36
  def channels_data; end
end

# pkg:gem/actioncable-next#lib/action_cable/test_case.rb:8
...
#
# pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:7
module ActionCable::TestHelper
  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:18
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:116
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:48
  ...
  #
  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:80
  def assert_no_broadcasts(stream, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:8
  def before_setup; end

  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:146
  ...
  #     end
  #
  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:96
  def capture_broadcasts(stream, &block); end

  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:146
  def clear_messages(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:142
  def pubsub_adapter; end

  private

  # pkg:gem/actioncable-next#lib/action_cable/test_helper.rb:149
  def new_broadcasts_from(current_messages, stream, assertion, &block); end
end

# pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:11
module ActionCable::VERSION; end

# pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:12
ActionCable::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:13
ActionCable::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:15
ActionCable::VERSION::PRE = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:17
ActionCable::VERSION::STRING = T.let(T.unsafe(nil), String)

# pkg:gem/actioncable-next#lib/action_cable/gem_version.rb:14
