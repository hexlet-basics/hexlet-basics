...
module Alba::Resource
  ...
  class << self
    ...
    # @api private
    #
    # source://alba//lib/alba/resource.rb#28
...
# Class methods
#
# source://alba//lib/alba/resource.rb#353
module Alba::Resource::ClassMethods
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#425
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#392
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#594
  ...
  # @see Alba::Association#initialize
  #
  # source://alba//lib/alba/resource.rb#468
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#634
  def helper(mod = T.unsafe(nil), &block); end

  # @api private
  #
  # source://alba//lib/alba/resource.rb#378
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#548
  ...
  # @see Alba::Association#initialize
  #
  # source://alba//lib/alba/resource.rb#466
  ...
  #
  # source://alba//lib/alba/resource.rb#357
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#494
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#604
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#626
  ...
  # @see Alba::Association#initialize
  #
  # source://alba//lib/alba/resource.rb#465
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#649
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#643
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#515
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#532
  def root_key!; end
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#525
  ...
  # @return [void]
  #
  # source://alba//lib/alba/resource.rb#560
  ...
  # @see #transform_keys
  #
  # source://alba//lib/alba/resource.rb#576
  def transform_keys!(type); end

  private

  # source://alba//lib/alba/resource.rb#398
  def assign_attributes(attrs, if_value); end

  # source://alba//lib/alba/resource.rb#407
  def assign_attributes_with_types(attrs_with_types, if_value, &block); end

  # source://alba//lib/alba/resource.rb#470
  def nesting; end

  # source://alba//lib/alba/resource.rb#611
...
module Alba::Resource::InstanceMethods
  ...
  #
  # source://alba//lib/alba/resource.rb#55
  ...
  # @return [String] serialized JSON string
  #
  # source://alba//lib/alba/resource.rb#71
  ...
  # source://alba//lib/alba/resource.rb#189
  def _key_for_collection; end
  ...
  # source://alba//lib/alba/resource.rb#229
  def attributes_to_hash(obj, hash); end

  # source://alba//lib/alba/resource.rb#339
  def check_within(association_name); end

  # source://alba//lib/alba/resource.rb#220
  def collection_converter; end

  # source://alba//lib/alba/resource.rb#214
  def converter; end

  # source://alba//lib/alba/resource.rb#131
  ...
  # source://alba//lib/alba/resource.rb#263
  def do_select(key, value, attribute); end

  # source://alba//lib/alba/resource.rb#291
  def fetch_attribute(obj, key, attribute); end

  # source://alba//lib/alba/resource.rb#306
  def fetch_attribute_from_object_and_resource(obj, attribute); end

  # @return [String]
  #
  # source://alba//lib/alba/resource.rb#184
  def fetch_key; end

  # source://alba//lib/alba/resource.rb#270
  def handle_error(error, obj, key, attribute, hash); end

  # source://alba//lib/alba/resource.rb#119
  def hash_from_traits(obj); end

  # source://alba//lib/alba/resource.rb#142
  def hash_with_metadata(hash, meta); end

  # source://alba//lib/alba/resource.rb#330
  def nil_handler; end

  # @raise [Alba::Error]
  #
  # source://alba//lib/alba/resource.rb#199
  ...
  # @return [Boolean]
  #
  # source://alba//lib/alba/resource.rb#210
...
# source://alba//lib/alba/resource.rb#655
...
class Alba::TypedAttribute
  ...
  #
  # source://alba//lib/alba/typed_attribute.rb#25
  ...
  # @api private
  #
  # source://alba//lib/alba/typed_attribute.rb#35
