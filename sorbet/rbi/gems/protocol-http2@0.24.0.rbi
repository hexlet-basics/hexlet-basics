...
class Protocol::HTTP2::Connection
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#526
  def closed_stream_id?(id); end

  # Traverse active streams and allow them to consume the available flow-control window.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#552
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#139
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#154
  def dependencies; end

  # Returns the value of attribute dependency.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#156
  def dependency; end
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#507
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#161
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#322
  def open!; end
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#297
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#178
  def read_frame; end
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#378
  def receive_data(frame); end

  # Receive and process a generic frame (default handler).
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#593
  def receive_frame(frame); end

  # Process a GOAWAY frame from the remote peer.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#234
  def receive_goaway(frame); end

  # On the server side, starts a new request.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#439
  def receive_headers(frame); end

  # Process a PING frame from the remote peer.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#358
  ...
  # @raise [ProtocolError]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#468
  def receive_push_promise(frame); end

  # Receive and process a RST_STREAM frame.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#538
  def receive_reset_stream(frame); end

  # Receive and process a SETTINGS frame from the remote peer.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#331
  def receive_settings(frame); end

  # Receive and process a WINDOW_UPDATE frame.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#565
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#205
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#500
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#173
  def synchronize; end
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#286
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#248
  def write_frame(frame); end

  # Write multiple frames within a synchronized block.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#260
