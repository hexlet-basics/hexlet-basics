...
module Bullet
  ...
  class << self
    ...
    # source://bullet//lib/bullet.rb#79
    def enabled=(enable); end

    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#85
    def enabled?; end
...
# source://bullet//lib/bullet/active_record81.rb#14
module Bullet::ActiveRecord
  class << self
    # source://bullet//lib/bullet/active_record81.rb#15
    def enable; end
  end
end
...
module Bullet::Dependency
  ...
  # @return [Boolean]
  #
  # source://bullet//lib/bullet/dependency.rb#153
  def mongoid7x?; end

  # @return [Boolean]
  #
  # source://bullet//lib/bullet/dependency.rb#157
  def mongoid8x?; end

  # @return [Boolean]
  #
  # source://bullet//lib/bullet/dependency.rb#161
  def mongoid9x?; end
  ...
  # source://bullet//lib/bullet/dependency.rb#48
...
# source://bullet//lib/bullet/active_record81.rb#4
module Bullet::SaveWithBulletSupport
  # source://bullet//lib/bullet/active_record81.rb#5
