...
class Typelizer::Interface
  ...
  # source://typelizer//lib/typelizer/interface.rb#76
  def fingerprint; end
  ...
  # source://typelizer//lib/typelizer/interface.rb#94
  def infer_types(props, hash_name = T.unsafe(nil)); end

  # source://typelizer//lib/typelizer/interface.rb#110
  def model_class; end

  # source://typelizer//lib/typelizer/interface.rb#118
...
class Typelizer::Property < ::Struct
  ...
  # source://typelizer//lib/typelizer/property.rb#20
  def fingerprint; end
  ...
  # source://typelizer//lib/typelizer/property.rb#27
  def type_name; end
