...
class RubyEventStore::ActiveRecord::EventRepository
  ...
  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#41
  def append_to_stream(records, stream, expected_version); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#69
  def count(specification); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#53
  def delete_stream(stream); end

  # @return [Boolean]
  #
  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#103
  def event_in_stream?(event_id, stream); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#99
  def global_position(event_id); end

  # @return [Boolean]
  #
  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#57
  def has_event?(event_id); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#61
  def last_stream_event(stream); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#47
  def link_to_stream(event_ids, stream, expected_version); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#95
  def position_in_stream(event_id, stream); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#65
  def read(specification); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#13
  def rescue_from_double_json_serialization!; end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#91
  def streams_of(event_id); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#73
  def update_messages(records); end

  private

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#109
  def add_to_stream(event_ids, stream, expected_version); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#180
  def append_to_stream_(records, stream, expected_version); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#138
  def compute_position(resolved_version, index); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#142
  def detect_index_violated(message); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#218
  def event_klass; end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#225
  ...
  # @return [Boolean]
  #
  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#229
  def json_data_type?(klass); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#175
  def link_to_stream_(event_ids, stream, expected_version); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#190
  def model_klasses; end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#167
  def optimize_timestamp(valid_at, created_at); end

  # @raise [EventDuplicatedInStream]
  #
  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#133
  def raise_error(e); end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#221
  def repo_reader; end

  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#171
  ...
  # source://ruby_event_store-active_record//lib/ruby_event_store/active_record/event_repository.rb#157
