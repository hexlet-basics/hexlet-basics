...
class Protocol::HTTP1::Connection
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:741
  def close!(error = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:733
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:876
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:451
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:348
  def read(length); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:357
  def read_line?; end

  # Read the body, assuming that we read until the connection is closed.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:825
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:406
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:945
  def read_request_body(method, headers); end

  # Read a request line from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:387
  def read_request_line; end

  # Read a response from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:462
  ...
  # - Otherwise, the body is read according to {read_body}.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:897
  def read_response_body(method, status, headers); end

  # Read a response line from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:439
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:846
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:796
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:519
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:760
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:701
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:659
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:597
  ...
  # If the request was a `HEAD` request, the body will be closed, and no data will be written.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:614
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:570
  ...
  # The connection will not be persistent after this method is called.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:538
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:865
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:862
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:868
