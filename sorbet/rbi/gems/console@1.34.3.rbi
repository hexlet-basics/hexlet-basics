...
# source://console//lib/console/compatible/logger.rb#11
module Console::Compatible; end

# A compatible interface for {::Logger} which can be used with {Console}.
#
# source://console//lib/console/compatible/logger.rb#13
class Console::Compatible::Logger < ::Logger
  # Create a new (compatible) logger.
  #
  # @return [Logger] a new instance of Logger
  #
  # source://console//lib/console/compatible/logger.rb#53
  def initialize(subject, output = T.unsafe(nil)); end

  # Log a message with the given severity.
  #
  # source://console//lib/console/compatible/logger.rb#66
  def add(severity, message = T.unsafe(nil), progname = T.unsafe(nil), **options); end

  # Format the severity.
  #
  # source://console//lib/console/compatible/logger.rb#99
...
#
# source://console//lib/console/compatible/logger.rb#15
class Console::Compatible::Logger::LogDevice
  # Create a new log device.
  #
  # @return [LogDevice] a new instance of LogDevice
  #
  # source://console//lib/console/compatible/logger.rb#20
  def initialize(subject, output); end

  # Log a message with the given severity.
  #
  # source://console//lib/console/compatible/logger.rb#36
  def call(*arguments, **options); end

  # Close the log device. This is a no-op.
  #
  # source://console//lib/console/compatible/logger.rb#45
  def close; end

  # Reopen the log device. This is a no-op.
  #
  # source://console//lib/console/compatible/logger.rb#41
  def reopen; end

  # Write a message to the log device.
  #
  # source://console//lib/console/compatible/logger.rb#28
