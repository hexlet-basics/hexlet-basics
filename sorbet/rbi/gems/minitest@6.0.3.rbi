...
module Minitest
  class << self
    ...
    # pkg:gem/minitest#lib/minitest/pride_plugin.rb:10
    def plugin_pride_init(options); end

    # pkg:gem/minitest#lib/minitest/pride_plugin.rb:4
...
#
# pkg:gem/minitest#lib/minitest/pride_plugin.rb:24
class Minitest::PrideIO
  # @return [PrideIO] a new instance of PrideIO
  #
  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:48
  def initialize(io); end

  # The IO we're going to pipe through.
  #
  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:46
  def io; end

  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:92
  def method_missing(msg, *args); end

  # Color a string.
  #
  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:85
  def pride(string); end

  # Wrap print to colorize the output.
  #
  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:60
  def print(o); end

  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:71
  def puts(*o); end

  class << self
    # Activate the pride plugin. Called from both -p option and minitest/pride
    #
    # pkg:gem/minitest#lib/minitest/pride_plugin.rb:28
    def pride!; end
    ...
    # @return [Boolean]
    #
    # pkg:gem/minitest#lib/minitest/pride_plugin.rb:35
    def pride?; end
  end
end
...
#
# pkg:gem/minitest#lib/minitest/pride_plugin.rb:40
Minitest::PrideIO::ESC = T.let(T.unsafe(nil), String)

# End the escape sequence
#
# pkg:gem/minitest#lib/minitest/pride_plugin.rb:43
...
#
# pkg:gem/minitest#lib/minitest/pride_plugin.rb:102
class Minitest::PrideLOL < ::Minitest::PrideIO
  # @return [PrideLOL] a new instance of PrideLOL
  #
  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:105
  def initialize(io); end

  # Make the string even more colorful. Damnit.
  #
  # pkg:gem/minitest#lib/minitest/pride_plugin.rb:129
  def pride(string); end
end

# pkg:gem/minitest#lib/minitest/pride_plugin.rb:103
