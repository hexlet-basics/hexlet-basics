...
class Faraday::Adapter
  # source://faraday/2.12.2/lib/faraday/adapter.rb#28
  def initialize(_app = T.unsafe(nil), opts = T.unsafe(nil), &block); end

  # source://faraday/2.12.2/lib/faraday/adapter.rb#55
  def call(env); end

  # source://faraday/2.12.2/lib/faraday/adapter.rb#50
  def close; end

  # source://faraday/2.12.2/lib/faraday/adapter.rb#41
  def connection(env); end

  private

  # source://faraday/2.12.2/lib/faraday/adapter.rb#85
  def request_timeout(type, options); end

  # source://faraday/2.12.2/lib/faraday/adapter.rb#62
