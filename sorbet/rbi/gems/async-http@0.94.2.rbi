...
#
# source://async-http//lib/async/http/body/hijack.rb#15
class Async::HTTP::Body::Hijack < ::Protocol::HTTP::Body::Readable
  # @return [Hijack] a new instance of Hijack
  #
  # source://async-http//lib/async/http/body/hijack.rb#24
  def initialize(block, input = T.unsafe(nil)); end

  # source://async-http//lib/async/http/body/hijack.rb#38
  def call(stream); end
  ...
  # @return [Boolean]
  #
  # source://async-http//lib/async/http/body/hijack.rb#45
  def empty?; end

  # Returns the value of attribute input.
  #
  # source://async-http//lib/async/http/body/hijack.rb#42
  def input; end

  # source://async-http//lib/async/http/body/hijack.rb#69
  def inspect; end

  # Read the next available chunk.
  #
  # source://async-http//lib/async/http/body/hijack.rb#54
  def read; end

  # @return [Boolean]
  #
  # source://async-http//lib/async/http/body/hijack.rb#49
  def ready?; end
  ...
  # @return [Boolean]
  #
  # source://async-http//lib/async/http/body/hijack.rb#34
  def stream?; end

  # source://async-http//lib/async/http/body/hijack.rb#73
  def to_s; end

  class << self
    # source://async-http//lib/async/http/body/hijack.rb#16
    def response(request, status, headers, &block); end

    # source://async-http//lib/async/http/body/hijack.rb#20
