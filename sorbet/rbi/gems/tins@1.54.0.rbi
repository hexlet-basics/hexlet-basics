...
# pkg:gem/tins#lib/tins/xt/full.rb:80
...
#   end
#
# pkg:gem/tins#lib/tins/xt/blank.rb:1
module Tins; end

# A module that provides methods to call private and protected methods on
# objects.
#
# pkg:gem/tins#lib/tins/ask_and_send.rb:4
module Tins::AskAndSend
  ...
  #
  # pkg:gem/tins#lib/tins/ask_and_send.rb:13
  ...
  # method doesn't exist
  #
  # pkg:gem/tins#lib/tins/ask_and_send.rb:28
  def ask_and_send!(method_name, *args, &block); end
  ...
  # doesn't exist
  #
  # pkg:gem/tins#lib/tins/ask_and_send.rb:45
  ...
  #
  # pkg:gem/tins#lib/tins/ask_and_send.rb:64
  def ask_and_send_or_self!(method_name, *args, &block); end
end
...
#   "foo".present?   # => true
#
# pkg:gem/tins#lib/tins/xt/blank.rb:19
...
#
# pkg:gem/tins#lib/tins/xt/blank.rb:73
module Tins::Blank::Array
  class << self
    ...
    #
    # pkg:gem/tins#lib/tins/xt/blank.rb:81
...
# This implementation aliases the `empty?` method to `blank?`.
#
# pkg:gem/tins#lib/tins/xt/blank.rb:92
module Tins::Blank::Hash
  class << self
    ...
    # @param modul [Object] the class or module that includes this module
    #
    # pkg:gem/tins#lib/tins/xt/blank.rb:100
    def included(modul); end
  end
end
...
#
# pkg:gem/tins#lib/tins/xt/blank.rb:39
module Tins::Blank::NilClass
  # Nil values are always considered blank.
  #
  # @return [Boolean] true (always)
  #
  # pkg:gem/tins#lib/tins/xt/blank.rb:44
  def blank?; end
end
...
#
# pkg:gem/tins#lib/tins/xt/blank.rb:122
module Tins::Blank::Numeric
  class << self
    ...
    # @param modul [Object] the class or module that includes this module
    #
    # pkg:gem/tins#lib/tins/xt/blank.rb:130
    def included(modul); end
  end
end
...
#
# pkg:gem/tins#lib/tins/xt/blank.rb:21
module Tins::Blank::Object
  ...
  #
  # pkg:gem/tins#lib/tins/xt/blank.rb:26
  def blank?; end
  ...
  #
  # pkg:gem/tins#lib/tins/xt/blank.rb:33
  def present?; end
end

# Blank behavior for String instances
#
# pkg:gem/tins#lib/tins/xt/blank.rb:108
module Tins::Blank::String
  ...
  #
  # pkg:gem/tins#lib/tins/xt/blank.rb:113
  def blank?; end
end

# Blank behavior for TrueClass instances
#
# pkg:gem/tins#lib/tins/xt/blank.rb:60
module Tins::Blank::TrueClass
  # True values are never considered blank.
  #
  # @return [Boolean] false (always)
  #
  # pkg:gem/tins#lib/tins/xt/blank.rb:64
  def blank?; end
end
...
#   end
#
# pkg:gem/tins#lib/tins/xt/full.rb:21
module Tins::Full
  ...
  #
  # pkg:gem/tins#lib/tins/xt/full.rb:74
  def all_full?; end
  ...
  #
  # pkg:gem/tins#lib/tins/xt/full.rb:46
...
#
# pkg:gem/tins#lib/tins/terminal.rb:12
module Tins::Terminal
  extend ::Tins::Terminal

  # pkg:gem/tins#lib/tins/terminal.rb:60
  def cols; end
  ...
  #
  # pkg:gem/tins#lib/tins/terminal.rb:55
  def columns; end

  # pkg:gem/tins#lib/tins/terminal.rb:46
  def lines; end
  ...
  #
  # pkg:gem/tins#lib/tins/terminal.rb:41
  def rows; end
  ...
  #
  # pkg:gem/tins#lib/tins/terminal.rb:21
  def winsize; end
end
