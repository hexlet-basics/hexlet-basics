...
func HasInfos() predicate.LanguageLesson {
	return predicate.LanguageLesson(func(s *sql.Selector) {
...
func HasInfosWith(preds ...predicate.LanguageLessonVersionInfo) predicate.LanguageLesson {
	return predicate.LanguageLesson(func(s *sql.Selector) {
		step := newInfosStep()
