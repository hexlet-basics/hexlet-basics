...
const (
	// Label holds the string label denoting the courselessontranslation type in the database.
	Label = "course_lesson_translation"
...
// OrderOption defines the ordering options for the CourseLessonTranslation queries.
