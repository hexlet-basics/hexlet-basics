...
const (
	// Label holds the string label denoting the courselessonversion type in the database.
	Label = "course_lesson_version"
...
// OrderOption defines the ordering options for the CourseLessonVersion queries.
