...
const (
	// Label holds the string label denoting the blogpostrelatedcourseitem type in the database.
	Label = "blog_post_related_course_item"
	...
	EdgeCourse = "course"
	// Table holds the table name of the blogpostrelatedcourseitem in the database.
...
// Columns holds all SQL columns for blogpostrelatedcourseitem fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the BlogPostRelatedCourseItem queries.
