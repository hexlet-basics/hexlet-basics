...
const (
	// Label holds the string label denoting the coursemoduletranslation type in the database.
	Label = "course_module_translation"
...
// OrderOption defines the ordering options for the CourseModuleTranslation queries.
