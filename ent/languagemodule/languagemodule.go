...
const (
	// Label holds the string label denoting the languagemodule type in the database.
	Label = "language_module"
	...
	FieldState = "state"
	// Table holds the table name of the languagemodule in the database.
	Table = "language_modules"
)

// Columns holds all SQL columns for languagemodule fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the LanguageModule queries.
