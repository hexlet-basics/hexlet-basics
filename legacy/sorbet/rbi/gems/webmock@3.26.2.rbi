...
# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:33
module Async; end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:34
module Async::HTTP; end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:16
class Async::HTTP::Client < ::Protocol::HTTP::Methods; end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:184
module Async::HTTP::WebMockApplication
  class << self
    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:194
    def add_webmock_response(request, webmock_response); end

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:188
    def call(request); end

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:200
    def get_webmock_response(request); end

    private

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:211
    def build_response(webmock_response); end

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:207
    def webmock_responses; end
  end
end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:185
Async::HTTP::WebMockApplication::WEBMOCK_REQUEST_ID_HEADER = T.let(T.unsafe(nil), String)

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:130
class Async::HTTP::WebMockClient < ::Async::HTTP::Client; end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:35
class Async::HTTP::WebMockClientWrapper < ::Async::HTTP::Client
  # @return [WebMockClientWrapper] a new instance of WebMockClientWrapper
  #
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:36
  def initialize(endpoint, protocol: T.unsafe(nil), scheme: T.unsafe(nil), authority: T.unsafe(nil), **options); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:53
  def call(request); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:90
  def close; end

  private

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:97
  def build_request_signature(request); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:108
  def build_webmock_response(response); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:122
  def build_webmock_response_headers(response); end
end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:133
class Async::HTTP::WebMockEndpoint
  # @return [WebMockEndpoint] a new instance of WebMockEndpoint
  #
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:134
  def initialize(scheme, authority, protocol); end

  # Returns the value of attribute authority.
  #
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:140
  def authority; end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:142
  def connect; end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:150
  def inspect; end
  ...
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:178
  def accept_socket(socket); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:160
  def create_connected_sockets; end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:156
...
# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:13
class WebMock::HttpLibAdapters::AsyncHttpClientAdapter < ::WebMock::HttpLibAdapter
  class << self
    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:24
    def disable!; end

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:19
    def enable!; end
  end
end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/async_http_client_adapter.rb:16
WebMock::HttpLibAdapters::AsyncHttpClientAdapter::OriginalAsyncHttpClient = Async::HTTP::Client
