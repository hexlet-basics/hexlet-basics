...
module CounterCulture
  ...
  class << self
    ...
    def supports_native_after_commit?; end
  end
end

# pkg:gem/counter_culture#lib/counter_culture/configuration.rb:25
class CounterCulture::Configuration
  # pkg:gem/counter_culture#lib/counter_culture/configuration.rb:28
  def initialize; end

  # pkg:gem/counter_culture#lib/counter_culture/configuration.rb:26
  def use_read_replica; end

  # pkg:gem/counter_culture#lib/counter_culture/configuration.rb:32
  def use_read_replica=(value); end

  private

  # pkg:gem/counter_culture#lib/counter_culture/configuration.rb:41
...
class CounterCulture::Counter
  ...
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:312
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:50
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:196
  ...
  # obj: object to calculate the counter cache name for
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:184
  ...
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:392
  def execute_now_or_after_commit(obj, &block); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:304
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:365
  def first_level_relation_foreign_key; end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:370
  ...
  #   current value
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:219
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:208
  ...
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:320
  def polymorphic?; end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:376
  ...
  #   that has the counter cache column
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:332
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:286
  ...
  #   we're actually looking for the old value -- only can change for polymorphic relations
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:345
  ...
  #   that has the counter cache column
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:273
  ...
  #   that has the counter cache column
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:247
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:426
  def assign_to_associated_object(obj, relation, change_counter_column, operator, delta_magnitude); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:456
  def association_object_clear_change(association_object, change_counter_column); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:437
  def association_object_for_assign(obj, relation); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:464
  def association_object_new_counter(association_object, change_counter_column, operator, delta_magnitude); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:415
  def attribute_was(obj, attr); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:468
  def primary_key_conditions(primary_key, fk_value); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:496
  def remember_counter_update(klass, id, column, delta, column_type); end

  # pkg:gem/counter_culture#lib/counter_culture/counter.rb:504
  ...
  class << self
    ...
    #
    # pkg:gem/counter_culture#lib/counter_culture/counter.rb:476
...
class CounterCulture::Reconciler::Reconciliation
  ...
  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:246
  def association_primary_key_select; end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:224
  def count_select; end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:263
  def join_clauses(where); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:196
  def log(message); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:208
  def log?; end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:202
  def log_without_newline(message); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:373
  def parameterize(string); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:241
  def primary_key_select; end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:367
  ...
  #
  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:361
  def quote_table_name(table_name); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:252
  def self_table_name; end

  # keep track of what we fixed, e.g. for a notification email
  #
  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:213
  def track_change(record, column_name, count); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:152
  def update_count_for_batch(column_name, records); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:381
  def with_reading_db_connection(&block); end

  # pkg:gem/counter_culture#lib/counter_culture/reconciler.rb:391
