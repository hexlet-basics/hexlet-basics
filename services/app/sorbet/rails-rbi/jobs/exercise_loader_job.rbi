...
class ExerciseLoaderJob
  sig { params(language_version_id: T.untyped).returns(ExerciseLoaderJob) }
  def self.perform_later(language_version_id); end

  sig { params(language_version_id: T.untyped).returns(ExerciseLoaderJob) }
  def self.perform_now(language_version_id); end
