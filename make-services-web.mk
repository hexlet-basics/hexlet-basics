web-exercises-load-php:
	...
	bundle exec rake "exercies:load[php]"
...
web-exercises-load-python:
	...
	bundle exec rake "exercies:load[python]"
...
web-exercises-load-ruby:
	...
	bundle exec rake "exercies:load[ruby]"
...
web-exercises-load-racket:
	...
	bundle exec rake "exercies:load[racket]"
...
web-exercises-load-javascript:
	...
	bundle exec rake "exercies:load[javascript]"
...
web-exercises-load-java:
	...
	bundle exec rake "exercies:load[java]"
...
web-exercises-load-html:
	...
	bundle exec rake "exercies:load[html]"
...
web-exercises-load-css:
	...
	bundle exec rake "exercies:load[css]"
...
web-exercises-load-elixir:
	...
	bundle exec rake "exercies:load[elixir]"
...
web-exercises-load-go:
	...
	bundle exec rake "exercies:load[go]"
