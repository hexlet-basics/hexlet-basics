  ...
  translation: {
    ...
    common: {
      ...
      check: {
        ...
        failed: {
          ...
          message:
            'В вашем коде есть ошибки. Прочитайте внимательно вывод тестов, найдите и попробуйте исправить их. <a>Как искать ошибки в коде</a>. Если не получается, поговорите с нашим ассистентом Тота во вкладке "ИИ-помощник".\n',
        },
        "failed-infinity": {
      ...
      errors: {
        ...
        server:
          "Ошибка на сервере. Возможно, скоро отпустит, а возможно — нет. Попробуйте узнать, что произошло в https://t.me/hexletcommunity/12",
      },
      export: "Экспорт",
      hello: "Привет мир",
      hours: {
    ...
    courses: {
      lessons: {
        show: {
          autocomplete_hint:
            "Редактор подсказывает команды по мере ввода. Нажмите Tab, чтобы принять подсказку, а клавишами ↑ и ↓ выбирайте нужную из списка.",
          ...
          common_questions: [
            {
              ...
              answer:
                'Команда проекта находится в <a target="_blank" href="https://t.me/hexletcommunity">телеграм-сообществе</a>. Там можно задать любой вопрос и повлиять на проект\n',
            },
            {
      ...
      courses: {
        index: {
          ...
          hexlet: {
            ...
            description:
              "Code Basics — это проект школы программирования Хекслет. Здесь вы закладываете базу и понимаете, как устроено программирование. Если хотите серьезно заняться разработкой и выйти на уровень профессии, переходите к платным программам Хекслет: с наставниками, практикой в реальных проектах и портфолио.",
