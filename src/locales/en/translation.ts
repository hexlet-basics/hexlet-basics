export default {
  translation: {
      ...
      profiles: {
        edit: {
          ...
          passkeys: {
            ...
            error: "Couldn't add the passkey. Please try again.",
            title: "Passkeys",
            unnamed: "Passkey",
          },
    ...
    common: {
      ...
      community_chat: "Community and support chat",
      ...
      telegram_channel: "Hexlet Telegram channel",
    ...
    flash: {
      ...
      magic_links: {
        create: {
          success: "If an account exists for this email, we've sent a sign-in link.",
        },
        show: {
    ...
    sessions: {
      new: {
        ...
        passkey_error: "Couldn't sign in with the passkey. Please try again.",
        password: "Password",
        register: "Sign up",
        reset_password: "Reset Password",
        sign_in: "Sign in",
