  ...
  translation: {
    ...
    activerecord: {
      attributes: {
        ...
        course: {
          ...
          readiness: "Disponibilidad del curso",
          "readiness/values": {
    ...
    admin: {
      ...
      banners: {
        ...
        form: {
          body_hint:
            "Se admite Markdown (por ejemplo, **negrita**). Todo el banner enlaza a la URL de abajo.",
        },
        index: {
          header: "Banners",
        },
    ...
    common: {
      ...
      unexpected_error: "Algo salió mal. Inténtalo de nuevo.",
    ...
    courses: {
      lessons: {
        show: {
          ...
          lesson: "Lesson",
          lesson_not_found: "Lección no encontrada. Prueba con otra lección.",
          locked: "Bloqueada",
    ...
    models: {
      attributes: {
        ...
        banner: {
          ...
          "background/values": {
            blue: "Azul",
            cta_gradient: "Degradado CTA",
            dark: "Oscuro",
          },
          body: "Texto (Markdown)",
          finishes_at: "Mostrar hasta",
          locale: "Idioma",
          "locale/values": {
            en: "Inglés",
            ru: "Ruso",
          },
          starts_at: "Mostrar desde",
          state: "Estado",
          "state/values": {
            archived: "Archivado",
            draft: "Borrador",
    ...
    phone_auth: {
      new: {
        hint: "Te enviaremos un código de un solo uso por SMS.",
        other_methods: "Otras opciones de inicio de sesión",
        phone: "Número de teléfono",
        submit: "Recibir el código",
        title: "Iniciar sesión por teléfono",
      },
      verify: {
        change_phone: "Cambiar el número",
        hint: "Introduce el código que enviamos a {{phone}}",
    ...
    sessions: {
      new: {
        ...
        passkey_error: "No se pudo iniciar sesión con la passkey. Inténtalo de nuevo.",
        password: "Password",
        register: "Sign up",
        reset_password: "Reset Password",
        sign_in: "Sign in",
