// Input attributes for auth forms, ported verbatim from legacy. They tune
// autofill, keyboards, and autocapitalization so password managers and mobile
// keyboards behave on the login/registration screens.
