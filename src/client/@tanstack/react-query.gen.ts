...
export const adminListCourseLessonMembersOptions = (options?: Options<AdminListCourseLessonMembersData>) => queryOptions<AdminListCourseLessonMembersResponse, AxiosError<AdminListCourseLessonMembersError>, AdminListCourseLessonMembersResponse, ReturnType<typeof adminListCourseLessonMembersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCourseLessonMembersInfiniteOptions = (options?: Options<AdminListCourseLessonMembersData>) => {
  const opts = infiniteQueryOptions<AdminListCourseLessonMembersResponse, AxiosError<AdminListCourseLessonMembersError>, InfiniteData<AdminListCourseLessonMembersResponse>, QueryKey<Options<AdminListCourseLessonMembersData>>, number | Pick<QueryKey<Options<AdminListCourseLessonMembersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
