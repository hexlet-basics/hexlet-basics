...
export const adminListUsersOptions = (options?: Options<AdminListUsersData>) => queryOptions<AdminListUsersResponse, AdminListUsersError, AdminListUsersResponse, ReturnType<typeof adminListUsersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListUsersInfiniteOptions = (options?: Options<AdminListUsersData>) => {
  const opts = infiniteQueryOptions<AdminListUsersResponse, AdminListUsersError, InfiniteData<AdminListUsersResponse>, QueryKey<Options<AdminListUsersData>>, number | Pick<QueryKey<Options<AdminListUsersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
 ...
 */
export const adminListBannersOptions = (options?: Options<AdminListBannersData>) => queryOptions<AdminListBannersResponse, AdminListBannersError, AdminListBannersResponse, ReturnType<typeof adminListBannersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListBannersInfiniteOptions = (options?: Options<AdminListBannersData>) => {
  const opts = infiniteQueryOptions<AdminListBannersResponse, AdminListBannersError, InfiniteData<AdminListBannersResponse>, QueryKey<Options<AdminListBannersData>>, number | Pick<QueryKey<Options<AdminListBannersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
 ...
 * Delete a banner.
 */
export const adminDeleteBannerMutation = (options?: Partial<Options<AdminDeleteBannerData>>): UseMutationOptions<AdminDeleteBannerResponse, AdminDeleteBannerError, Options<AdminDeleteBannerData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteBannerResponse, AdminDeleteBannerError, Options<AdminDeleteBannerData>> = {
    mutationFn: async (fnOptions) => {
...
export const adminListBlogPostsOptions = (options?: Options<AdminListBlogPostsData>) => queryOptions<AdminListBlogPostsResponse, AdminListBlogPostsError, AdminListBlogPostsResponse, ReturnType<typeof adminListBlogPostsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListBlogPostsInfiniteOptions = (options?: Options<AdminListBlogPostsData>) => {
  const opts = infiniteQueryOptions<AdminListBlogPostsResponse, AdminListBlogPostsError, InfiniteData<AdminListBlogPostsResponse>, QueryKey<Options<AdminListBlogPostsData>>, number | Pick<QueryKey<Options<AdminListBlogPostsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminDeleteBlogPostMutation = (options?: Partial<Options<AdminDeleteBlogPostData>>): UseMutationOptions<AdminDeleteBlogPostResponse, AdminDeleteBlogPostError, Options<AdminDeleteBlogPostData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteBlogPostResponse, AdminDeleteBlogPostError, Options<AdminDeleteBlogPostData>> = {
    mutationFn: async (fnOptions) => {
 ...
 */
export const adminListCourseCategoriesOptions = (options?: Options<AdminListCourseCategoriesData>) => queryOptions<AdminListCourseCategoriesResponse, AdminListCourseCategoriesError, AdminListCourseCategoriesResponse, ReturnType<typeof adminListCourseCategoriesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCourseCategoriesInfiniteOptions = (options?: Options<AdminListCourseCategoriesData>) => {
  const opts = infiniteQueryOptions<AdminListCourseCategoriesResponse, AdminListCourseCategoriesError, InfiniteData<AdminListCourseCategoriesResponse>, QueryKey<Options<AdminListCourseCategoriesData>>, number | Pick<QueryKey<Options<AdminListCourseCategoriesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListCategoryQnaItemsOptions = (options: Options<AdminListCategoryQnaItemsData>) => queryOptions<AdminListCategoryQnaItemsResponse, AdminListCategoryQnaItemsError, AdminListCategoryQnaItemsResponse, ReturnType<typeof adminListCategoryQnaItemsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminDeleteCategoryQnaItemMutation = (options?: Partial<Options<AdminDeleteCategoryQnaItemData>>): UseMutationOptions<AdminDeleteCategoryQnaItemResponse, AdminDeleteCategoryQnaItemError, Options<AdminDeleteCategoryQnaItemData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteCategoryQnaItemResponse, AdminDeleteCategoryQnaItemError, Options<AdminDeleteCategoryQnaItemData>> = {
    mutationFn: async (fnOptions) => {
 ...
 */
export const adminDeleteCourseCategoryMutation = (options?: Partial<Options<AdminDeleteCourseCategoryData>>): UseMutationOptions<AdminDeleteCourseCategoryResponse, AdminDeleteCourseCategoryError, Options<AdminDeleteCourseCategoryData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteCourseCategoryResponse, AdminDeleteCourseCategoryError, Options<AdminDeleteCourseCategoryData>> = {
    mutationFn: async (fnOptions) => {
...
export const adminListCourseLandingPagesOptions = (options?: Options<AdminListCourseLandingPagesData>) => queryOptions<AdminListCourseLandingPagesResponse, AdminListCourseLandingPagesError, AdminListCourseLandingPagesResponse, ReturnType<typeof adminListCourseLandingPagesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCourseLandingPagesInfiniteOptions = (options?: Options<AdminListCourseLandingPagesData>) => {
  const opts = infiniteQueryOptions<AdminListCourseLandingPagesResponse, AdminListCourseLandingPagesError, InfiniteData<AdminListCourseLandingPagesResponse>, QueryKey<Options<AdminListCourseLandingPagesData>>, number | Pick<QueryKey<Options<AdminListCourseLandingPagesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminDeleteCourseLandingPageMutation = (options?: Partial<Options<AdminDeleteCourseLandingPageData>>): UseMutationOptions<AdminDeleteCourseLandingPageResponse, AdminDeleteCourseLandingPageError, Options<AdminDeleteCourseLandingPageData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteCourseLandingPageResponse, AdminDeleteCourseLandingPageError, Options<AdminDeleteCourseLandingPageData>> = {
    mutationFn: async (fnOptions) => {
...
export const adminListLandingPageQnaItemsOptions = (options: Options<AdminListLandingPageQnaItemsData>) => queryOptions<AdminListLandingPageQnaItemsResponse, AdminListLandingPageQnaItemsError, AdminListLandingPageQnaItemsResponse, ReturnType<typeof adminListLandingPageQnaItemsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminDeleteLandingPageQnaItemMutation = (options?: Partial<Options<AdminDeleteLandingPageQnaItemData>>): UseMutationOptions<AdminDeleteLandingPageQnaItemResponse, AdminDeleteLandingPageQnaItemError, Options<AdminDeleteLandingPageQnaItemData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteLandingPageQnaItemResponse, AdminDeleteLandingPageQnaItemError, Options<AdminDeleteLandingPageQnaItemData>> = {
    mutationFn: async (fnOptions) => {
...
export const adminListCourseLessonMembersOptions = (options?: Options<AdminListCourseLessonMembersData>) => queryOptions<AdminListCourseLessonMembersResponse, AdminListCourseLessonMembersError, AdminListCourseLessonMembersResponse, ReturnType<typeof adminListCourseLessonMembersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCourseLessonMembersInfiniteOptions = (options?: Options<AdminListCourseLessonMembersData>) => {
  const opts = infiniteQueryOptions<AdminListCourseLessonMembersResponse, AdminListCourseLessonMembersError, InfiniteData<AdminListCourseLessonMembersResponse>, QueryKey<Options<AdminListCourseLessonMembersData>>, number | Pick<QueryKey<Options<AdminListCourseLessonMembersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListCourseLessonReviewsOptions = (options?: Options<AdminListCourseLessonReviewsData>) => queryOptions<AdminListCourseLessonReviewsResponse, AdminListCourseLessonReviewsError, AdminListCourseLessonReviewsResponse, ReturnType<typeof adminListCourseLessonReviewsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCourseLessonReviewsInfiniteOptions = (options?: Options<AdminListCourseLessonReviewsData>) => {
  const opts = infiniteQueryOptions<AdminListCourseLessonReviewsResponse, AdminListCourseLessonReviewsError, InfiniteData<AdminListCourseLessonReviewsResponse>, QueryKey<Options<AdminListCourseLessonReviewsData>>, number | Pick<QueryKey<Options<AdminListCourseLessonReviewsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListCourseLessonsOptions = (options?: Options<AdminListCourseLessonsData>) => queryOptions<AdminListCourseLessonsResponse, AdminListCourseLessonsError, AdminListCourseLessonsResponse, ReturnType<typeof adminListCourseLessonsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCourseLessonsInfiniteOptions = (options?: Options<AdminListCourseLessonsData>) => {
  const opts = infiniteQueryOptions<AdminListCourseLessonsResponse, AdminListCourseLessonsError, InfiniteData<AdminListCourseLessonsResponse>, QueryKey<Options<AdminListCourseLessonsData>>, number | Pick<QueryKey<Options<AdminListCourseLessonsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListCoursesOptions = (options?: Options<AdminListCoursesData>) => queryOptions<AdminListCoursesResponse, AdminListCoursesError, AdminListCoursesResponse, ReturnType<typeof adminListCoursesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListCoursesInfiniteOptions = (options?: Options<AdminListCoursesData>) => {
  const opts = infiniteQueryOptions<AdminListCoursesResponse, AdminListCoursesError, InfiniteData<AdminListCoursesResponse>, QueryKey<Options<AdminListCoursesData>>, number | Pick<QueryKey<Options<AdminListCoursesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListLeadsOptions = (options?: Options<AdminListLeadsData>) => queryOptions<AdminListLeadsResponse, AdminListLeadsError, AdminListLeadsResponse, ReturnType<typeof adminListLeadsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListLeadsInfiniteOptions = (options?: Options<AdminListLeadsData>) => {
  const opts = infiniteQueryOptions<AdminListLeadsResponse, AdminListLeadsError, InfiniteData<AdminListLeadsResponse>, QueryKey<Options<AdminListLeadsData>>, number | Pick<QueryKey<Options<AdminListLeadsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListRolesOptions = (options?: Options<AdminListRolesData>) => queryOptions<AdminListRolesResponse, AdminListRolesError, AdminListRolesResponse, ReturnType<typeof adminListRolesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListRolesInfiniteOptions = (options?: Options<AdminListRolesData>) => {
  const opts = infiniteQueryOptions<AdminListRolesResponse, AdminListRolesError, InfiniteData<AdminListRolesResponse>, QueryKey<Options<AdminListRolesData>>, number | Pick<QueryKey<Options<AdminListRolesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminDeleteRoleMutation = (options?: Partial<Options<AdminDeleteRoleData>>): UseMutationOptions<AdminDeleteRoleResponse, AdminDeleteRoleError, Options<AdminDeleteRoleData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteRoleResponse, AdminDeleteRoleError, Options<AdminDeleteRoleData>> = {
    mutationFn: async (fnOptions) => {
...
export const adminListStaffMembersOptions = (options?: Options<AdminListStaffMembersData>) => queryOptions<AdminListStaffMembersResponse, AdminListStaffMembersError, AdminListStaffMembersResponse, ReturnType<typeof adminListStaffMembersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListStaffMembersInfiniteOptions = (options?: Options<AdminListStaffMembersData>) => {
  const opts = infiniteQueryOptions<AdminListStaffMembersResponse, AdminListStaffMembersError, InfiniteData<AdminListStaffMembersResponse>, QueryKey<Options<AdminListStaffMembersData>>, number | Pick<QueryKey<Options<AdminListStaffMembersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminDeleteStaffMemberMutation = (options?: Partial<Options<AdminDeleteStaffMemberData>>): UseMutationOptions<AdminDeleteStaffMemberResponse, AdminDeleteStaffMemberError, Options<AdminDeleteStaffMemberData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteStaffMemberResponse, AdminDeleteStaffMemberError, Options<AdminDeleteStaffMemberData>> = {
    mutationFn: async (fnOptions) => {
...
export const adminListManagementUsersOptions = (options?: Options<AdminListManagementUsersData>) => queryOptions<AdminListManagementUsersResponse, AdminListManagementUsersError, AdminListManagementUsersResponse, ReturnType<typeof adminListManagementUsersQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListManagementUsersInfiniteOptions = (options?: Options<AdminListManagementUsersData>) => {
  const opts = infiniteQueryOptions<AdminListManagementUsersResponse, AdminListManagementUsersError, InfiniteData<AdminListManagementUsersResponse>, QueryKey<Options<AdminListManagementUsersData>>, number | Pick<QueryKey<Options<AdminListManagementUsersData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListMessagesOptions = (options?: Options<AdminListMessagesData>) => queryOptions<AdminListMessagesResponse, AdminListMessagesError, AdminListMessagesResponse, ReturnType<typeof adminListMessagesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListMessagesInfiniteOptions = (options?: Options<AdminListMessagesData>) => {
  const opts = infiniteQueryOptions<AdminListMessagesResponse, AdminListMessagesError, InfiniteData<AdminListMessagesResponse>, QueryKey<Options<AdminListMessagesData>>, number | Pick<QueryKey<Options<AdminListMessagesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminListReviewsOptions = (options?: Options<AdminListReviewsData>) => queryOptions<AdminListReviewsResponse, AdminListReviewsError, AdminListReviewsResponse, ReturnType<typeof adminListReviewsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const adminListReviewsInfiniteOptions = (options?: Options<AdminListReviewsData>) => {
  const opts = infiniteQueryOptions<AdminListReviewsResponse, AdminListReviewsError, InfiniteData<AdminListReviewsResponse>, QueryKey<Options<AdminListReviewsData>>, number | Pick<QueryKey<Options<AdminListReviewsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
...
export const adminDeleteReviewMutation = (options?: Partial<Options<AdminDeleteReviewData>>): UseMutationOptions<AdminDeleteReviewResponse, AdminDeleteReviewError, Options<AdminDeleteReviewData>> => {
  const mutationOptions: UseMutationOptions<AdminDeleteReviewResponse, AdminDeleteReviewError, Options<AdminDeleteReviewData>> = {
    mutationFn: async (fnOptions) => {
 ...
 */
export const listBlogPostsOptions = (options?: Options<ListBlogPostsData>) => queryOptions<ListBlogPostsResponse, ListBlogPostsError, ListBlogPostsResponse, ReturnType<typeof listBlogPostsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const listBlogPostsInfiniteOptions = (options?: Options<ListBlogPostsData>) => {
  const opts = infiniteQueryOptions<ListBlogPostsResponse, ListBlogPostsError, InfiniteData<ListBlogPostsResponse>, QueryKey<Options<ListBlogPostsData>>, number | Pick<QueryKey<Options<ListBlogPostsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
 ...
 */
export const listPublicCourseCategoriesOptions = (options?: Options<ListPublicCourseCategoriesData>) => queryOptions<ListPublicCourseCategoriesResponse, ListPublicCourseCategoriesError, ListPublicCourseCategoriesResponse, ReturnType<typeof listPublicCourseCategoriesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const listCoursesOptions = (options?: Options<ListCoursesData>) => queryOptions<ListCoursesResponse, ListCoursesError, ListCoursesResponse, ReturnType<typeof listCoursesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const switchLocaleOptions = (options: Options<SwitchLocaleData>) => queryOptions<SwitchLocaleResponse, SwitchLocaleError, SwitchLocaleResponse, ReturnType<typeof switchLocaleQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getSitemapOptions = (options?: Options<GetSitemapData>) => queryOptions<GetSitemapResponse, GetSitemapError, GetSitemapResponse, ReturnType<typeof getSitemapQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const newPasskeySessionOptions = (options?: Options<NewPasskeySessionData>) => queryOptions<NewPasskeySessionResponse, NewPasskeySessionError, NewPasskeySessionResponse, ReturnType<typeof newPasskeySessionQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const listPublicReviewsOptions = (options?: Options<ListPublicReviewsData>) => queryOptions<ListPublicReviewsResponse, ListPublicReviewsError, ListPublicReviewsResponse, ReturnType<typeof listPublicReviewsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
...
export const listPublicReviewsInfiniteOptions = (options?: Options<ListPublicReviewsData>) => {
  const opts = infiniteQueryOptions<ListPublicReviewsResponse, ListPublicReviewsError, InfiniteData<ListPublicReviewsResponse>, QueryKey<Options<ListPublicReviewsData>>, number | Pick<QueryKey<Options<ListPublicReviewsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
  // @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
