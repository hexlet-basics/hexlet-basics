-- River job-queue schema (river v0.41.0, line 'main'), generated by
-- `river migrate-get --up --all --line main`. river owns these tables; atlas
-- applies them so the test/CI flow (atlas migrate apply) provisions the queue.
-- Regenerate from the CLI on a river upgrade; do not hand-edit.
