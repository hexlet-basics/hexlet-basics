...
// chat → lesson progress → course/lesson; the lesson's infos are
// locale-filtered and id-ordered so the converter's "first info" name lookup
// matches the lesson progress list's convention.
